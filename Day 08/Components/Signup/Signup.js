...
function Signup() {
  ...
  const [signup, setSignup] = useState(new User().onSignup());
    ...
    <div className='SignupBorder' style={BoxStyle}>
      ...
      <div className='SignupBox'>
        ...
        <form onSubmit={handleSubmit} className='SignupBoxForm'>
          {step === 1 && (
            <>
              <div className={`SignupBoxInput input-1 ${error.fullname ? 'SignupBoxInvalidInput' : ''}`}>
                <input
                  onChange={handleChange}
                  type='text'
                  name='fullname'
                  id='fullname'
                  value={signup.get('fullname')}
          ...
          {step === 2 && (
            <>
              <div className={`SignupBoxInput input-4 ${error.mobile ? 'SignupBoxInvalidInput' : ''}`}>
                <input
                  onChange={handleChange}
                  type='tel'
                  name='mobile'
